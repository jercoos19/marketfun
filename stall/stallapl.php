	...
	<body class="subpage">
		...
		<!-- Main -->
			<section id="main" class="wrapper">
				<div class="inner">
					<div class="stallapl">
						<form method="POST" action="../stall/stallapl_check.php" enctype="multipart/form-data">
							<ul>
								<h3>申請擺攤</h3>
								<li class="liset">
									<div class='ae_border'>
										<h5>攤商名字</h5>
										<input type="text" name="_sname" id="_sname" placeholder="攤商名字" required/>
									</div>
								</li>
								<li class="liset">
									<div class='ae_border'>
										<h5>攤位商品內容</h5>
										<input type="text" name="_scontent" id="_scontent" placeholder="擺攤內容" required/>
									</div>
								</li>
								<li class="liset">
									<div class='ae_border'>
										<h5>申請的攤位位置</h5>
										<input type="text" name="_sposition" id="_sposition" placeholder="擺攤位置" required/>
									</div>
								</li>
								<li class="liset">
									<div class='ae_border'>
							...
							<?php
								echo "<input type=hidden value='$eid' name='_eid' id='_eid'>";
								echo "<input type=hidden value='$ename' name='_ename' id='_ename'>";
							?>
